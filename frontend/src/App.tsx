...
Designed for legal teams and arbitrators, it enables strategic decision-making. Ultimately, it provides confidence and precision, ensuring your arbitration framework is optimally positioned for enforcement and success.`;

export default function App() {
  const [currentPage, setCurrentPage] = useState<"welcome" | "login" | "main">(
    "welcome"
  );
  ...
  if (bootstrapping) {
    return (
      <div className="size-full flex items-center justify-center bg-gradient-to-br from-gray-900 via-black to-gray-800 text-gray-300">
        Loading...
      </div>
    );
  }
  ...
  return (
    <div className="size-full flex items-center justify-center bg-gradient-to-br from-gray-900 via-black to-gray-800 overflow-hidden relative">
      ...
      {/* Content Card */}
      <motion.div
        className="max-w-2xl mx-auto px-8 py-12 text-center relative z-10 bg-gray-900/30 backdrop-blur-sm rounded-3xl border border-gray-600/40"
      ...
      >
        ...
        <motion.p
          ...
          className="text-gray-400 mb-8 leading-relaxed max-w-lg mx-auto whitespace-pre-line"
        >
          {HERO_TEXT}
        </motion.p>
